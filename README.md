...
It uses the 'jsoncpp' package downloaded with Vcpkg (For more information about this package, please read [jsoncpp](https://github.com/open-source-parsers/jsoncpp). We advise you to use the static library.
